describe("Simulacion de registrar una MASCOTA sin sesion activa", () => {
    it("La simulacion debe intetar registrar una mascota en el sistema sin haber iniciado sesion", () => {
